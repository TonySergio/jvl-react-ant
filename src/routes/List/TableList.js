...
export default class TableList extends PureComponent {
  ...
  handleModalVisible = e => {
    this.props.dispatch(routerRedux.push('/list/basic-form'));
  };
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          <Col md={8} sm={24}>
            <FormItem label="Serial num">
              {getFieldDecorator('no')(<Input placeholder="enter..." />)}
            </FormItem>
          </Col>
          <Col md={8} sm={24}>
  ...
  renderAdvancedForm() {
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        ...
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          <Col md={8} sm={24}>
            <FormItem label="Date of last request">
  ...
  render() {
    ...
    return (
      <PageHeaderLayout title="List of registered machines">
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>{this.renderForm()}</div>
            <div className={styles.tableListOperator}>
              <Button icon="plus" type="primary" onClick={(e) => this.handleModalVisible(e)}>
                Add new machine
              </Button>
